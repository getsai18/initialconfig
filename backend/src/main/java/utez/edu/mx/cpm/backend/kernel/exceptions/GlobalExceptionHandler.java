...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleNoRoute(NoResourceFoundException ex) {
    ...
    private ResponseEntity<ApiResponse> build(HttpStatus status, String message, Map<String, String> fieldErrors) {
        ApiResponse body = ApiResponse.failure(message, fieldErrors);
