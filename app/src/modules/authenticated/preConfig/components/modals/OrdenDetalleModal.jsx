...
export default function OrdenDetalleModal({ visible, ordenId, pedidoActivo, onClose, onGuardarPrendasOrden }) {
  ...
  // Legacy orders created before per-order adjuntos existed fall back to the pedido's list.
  // Los archivos adjuntos solo se muestran aquí — agregarlos/quitarlos ya no es
  // posible desde una orden ya creada.
  ...
  // Solo se puede agregar cantidad/talla/género de tipos que la orden ya tenía —
  // esta vista de edición no permite introducir un tipo de prenda nuevo.
