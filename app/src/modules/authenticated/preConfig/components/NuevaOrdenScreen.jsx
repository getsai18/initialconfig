...
const Pants = (props) => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 4h16v16H4z"/></svg>;
...
function AreasForm({ areasActivas, onToggleArea, onQuitarActividad, onAbrirModalActividades, onSelectTagOp, onToggleMulti, onTextChange, onCustomOtroToggle, onCustomOtroChange, tpuAlert }) {
  // Inline confirmation state for removing an activity
  const [pendingRemove, setPendingRemove] = useState(null);

  function handleQuitarClick(ai, li) {
...
function onToggleMulti(areaIdx, actIdx, option) {
  ...
  const noAreasActivas = (areasActivas || []).every((a) => !a.activa);
          ...
          <div className={`form-section bg-white border border-gray-200 rounded-xl mb-4${collapsed['adjuntos'] ? ' collapsed' : ''}`}>
            ...
            <div className="form-section-body p-5">
              ...
              <div
                ...
                onClick={() => document.getElementById('no-adj-input').click()}
              >
