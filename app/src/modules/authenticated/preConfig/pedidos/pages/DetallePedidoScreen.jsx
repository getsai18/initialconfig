...
export default function DetallePedidoScreen({
  ...
  if (modalAccion.accion === 'eliminar') {
    modalConfig = { title: `Eliminar ${modalAccion.tipo === 'kit' ? 'Kit' : 'Orden'}`, body: `¿Estás seguro de que deseas eliminar este/a ${modalAccion.tipo}? Si tiene información adentro también se quitará del pedido.`, confirmStr: 'Sí, eliminar', btnColor: 'bg-red-600 hover:bg-red-700' };
  }
